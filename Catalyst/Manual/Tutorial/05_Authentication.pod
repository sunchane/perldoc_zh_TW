...
Catalyst::Manual::Tutorial::05_Authentication - Catalyst 教學手冊 - 第 5 章: 驗證

=head1 OVERVIEW

這是 B<章節 5 全部 10> Catalyst 教學手冊。
...
現在我們為多功能應用程式加入最後的功能，我們專注在提供驗證 (下個章節B<授權>請看 L<Chapter 6|Catalyst::Manual::Tutorial::06_Authorization>)。
...
本教學手冊的原始檔包含在教學虛擬電腦中的 F</home/catalyst/Final> 資料夾中 (每章節各一資料夾)。
這裡也有下載原始檔的指引 L<Catalyst::Manual::Tutorial::01_Intro>。
