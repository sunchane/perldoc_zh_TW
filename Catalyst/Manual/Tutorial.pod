...
Catalyst::Manual::Tutorial - Catalyst 教學手冊：概觀
...
Catalyst 框架是一個彈性及全面的環境，提供建構高功能性的網頁程式框架。
本教學手冊設計提供快速介紹基本概念，及最常見的使用功能，並且專注在真實世界的實務練習。
...
我們建議您在網路上閱讀這份說明文件。
訪問 L<Catalyst::Manual::Tutorial> 確保您是閱讀最新版本的文件。
另一種方法您可以使用 CPAN 模組像是 L<Pod::Webserver>, L<Pod::POM::Web>,
L<Pod::Browser> (Catalyst 為基礎)，或 L<CPAN::Mini::Webserver> 閱讀本地教學手冊的副本。
