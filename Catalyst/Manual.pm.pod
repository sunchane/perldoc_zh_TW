...
Catalyst::Manual - Catalyst 開發者說明手冊
...
要進行本教學手冊請安裝 L<Task::Catalyst::Tutorial> 並且安裝其他依賴模組。
您也可以參考 L<Catalyst::Manual::Tutorial::Intro|Catalyst::Manual::Tutorial::01_Intro> 更多安裝資訊選項。
...
有關 Catalyst 更多的資訊，目前有 2 本實體書供販售。
