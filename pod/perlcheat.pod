...
這份 '速查表' 是個隨身的參考，指的是 Perl 程式設計新手。
不是所有東西都有提到，只有 195 個功能，我看您已經招架不住了。
...
本文的第一個版本出現在 Perl Monks，有來自許多人的建議。 謝謝您，Perl Monks。
...
特別感謝達米安. 康威，不只建議重要的改變，也花許多時間計算功能的數量，
還做了 Raku 版本讓 Perl 保持 Perl。
