...
本文從頭描述所有 Perl 物件導向 (OO) 功能。
如果您只是在找一些能教您寫些物件導向的程式，您最好參閱 L<perlootut> 
使用其中一種來自 CPAN 提供的物件系統。
...
如果您在找如何寫出您自己的物件系統，或您需要維護物件實做的草案，
本說明文件會幫助您明確了解 Perl 為物件導向做了什麼。
